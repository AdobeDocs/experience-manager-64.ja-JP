...
* コンポーネントは要素名で識別されます。コンポーネントの名前を変更するには、![cmppr](assets/cmppr.png) をタップし、プロパティブラウザーで&#x200B;**[!UICONTROL 要素名]**&#x200B;フィールドの値を変更してください。要素名フィールドに使用できるのは、英字、数字、ハイフン（-）およびアンダースコア（_）のみです。その他の特殊文字は使用できません。また、要素名は英字で始まる必要があります。
