...
1. `https://[hostname]:[portport]/aem/forms.html.`にアクセスして、AEM Formsのユーザーインターフェイスにログインします
1. 削除するフォームを探して選択します。ツールバーの「![aem6forms_delete2](assets/aem6forms_delete2.png)を削除」をクリックし、削除操作を確認します。
