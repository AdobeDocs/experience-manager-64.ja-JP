...
[](/help/forms/using/upgrade.md)AEM Forms6.3または6.2からAEM Forms6.4の最新バージョンにアップグレードするか、新規インストールを実行できます。 以前のインストール環境をアップグレードしたのか、新規インストールを実行したのかに応じて、以下に示すいずれかの手順を実行してください。
