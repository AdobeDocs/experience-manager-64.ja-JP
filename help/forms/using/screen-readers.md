...
* **（Internal Explorer 9のみ）** HTML5フォームでは、ページはオンデマンドで（動的に）読み込まれます。 オンデマンドのページ読み込みは、スクリーンリーダーの機能で問題が生じます。スクリーンリーダーのフォーカスがページの最後のフィールドにあり、ユーザーがTabキーを押すと、フォーカスが次のページの最初のフィールドに設定されるのではなく、フォームの最初のページの最初のフィールドに戻ります。
