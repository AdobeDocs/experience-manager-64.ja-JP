...
各セクションの太字のテキストはスタティックテキストを表します。データベースには、顧客、請求および通話テーブルが含まれます。 フォームデータモデルは、これらのテーブルのいずれかのデータを受信することができます。詳しくは、「[フォームデータモデルの作成](create-form-data-model-tutorial.md)」を参照してください。
