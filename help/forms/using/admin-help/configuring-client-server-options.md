...
1. 「名前」ボックスに、新しい透かしの名前を入力します。
   ...
   ***注意&#x200B;**：一部の特殊文字は、透かしや透かし要素の名前と説明に使用できません。[ポリシーの編集に関する考慮事項](/help/forms/using/admin-help/creating-policies.md#considerations-for-editing-policies)に示されている制限を参照してください。*
