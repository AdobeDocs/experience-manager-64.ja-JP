...
1. 管理コンソールで、 **[!UICONTROL 設定/ユーザー管理/ユーザーとグループ]**&#x200B;をクリックし、 **[!UICONTROL 新しいユーザー]**..
1. の下 **[!UICONTROL 一般設定]**&#x200B;必要に応じて情報を入力し、「 **[!UICONTROL 次へ]**. この設定について詳しくは、[ユーザー設定](adding-configuring-users.md#user-settings)を参照してください。
1. （オプション）ユーザーをグループに追加するには、 **[!UICONTROL グループの検索]**&#x200B;次のタスクを実行します。

   * 内 **[!UICONTROL 検索]** ボックスに、グループ名のすべてまたは一部を入力します。
   * 検索するドメインを選択し、表示する項目数を選択して、 **[!UICONTROL 検索]**.
   * （オプション）グループの詳細を表示するには、グループ名を選択し、 **[!UICONTROL OK]** をクリックして、検索結果ページに戻ります。
   * グループのチェックボックスを選択し、 **[!UICONTROL OK]**.
   * 「**[!UICONTROL 次へ]**」をクリックします。

1. （オプション）ユーザーに役割を割り当てるには、 **[!UICONTROL ロールの検索]**、割り当てる役割のチェックボックスを選択し、 **[!UICONTROL OK]**.
...
エンタープライズドメインでは、ユーザーの DN はユーザーが組織内の別の部署に移動すると変更される場合があるので、ユーザー ID として DN 以外の属性を使用します。この設定は、ディレクトリサーバーによって異なります。値は `objectGUID` （Active Directory 2003 の場合） `nsuniqueID` Sun™ One、 `guid` （eDirectory 用）
...
1. 管理コンソールで、 **[!UICONTROL 設定/ユーザー管理/ユーザーとグループ]**.
1. 特定のユーザーに対する検索を絞り込むための情報を指定し、 **[!UICONTROL 検索]**. 検索の結果がページの下部に表示されます。列見出しをクリックすると、リストを並べ替えることができます。
1. ユーザー名をクリックし、 **[!UICONTROL パスワードを変更]**.
1. 新しいパスワードを入力して確認し、「 **[!UICONTROL OK]**. パスワードは最低 8 文字必要です。
...
1. 編集するユーザーを検索するには、次のタスクを実行します。
   ...
   * 内 **[!UICONTROL 検索]** 」ボックスに、検索条件を入力します。
   * 内 **[!UICONTROL 使用]** リスト、選択 **[!UICONTROL 名前]**, **[!UICONTROL 電子メール]**&#x200B;または **[!UICONTROL ユーザー ID]**.
   * 内 **[!UICONTROL リスト内]**&#x200B;を選択します。 **[!UICONTROL ユーザー]**.
   * ドメインを選択し、表示する項目数を選択して、 **[!UICONTROL 検索]**.

1. 編集するユーザーをクリックします。
1. ローカルドメインまたはハイブリッドドメインのユーザーの場合、 **[!UICONTROL 詳細]** タブ、編集 **[!UICONTROL 一般設定]** および **[!UICONTROL ログイン設定]**&#x200B;をクリックし、 **[!UICONTROL 保存]**. この設定について詳しくは、[ユーザー設定](adding-configuring-users.md#user-settings)を参照してください。エンタープライズドメインに属するユーザーの一般設定およびログイン設定は、編集できません。
1. ユーザーのグループ設定を編集するには、 **[!UICONTROL グループメンバーシップ]** タブに移動し、次のタスクを実行します。

   * クリック **[!UICONTROL グループを検索]** 検索情報を入力します。
   * ユーザーを新しいグループに追加するには、そのグループのチェックボックスをオンにして、 **[!UICONTROL OK]**&#x200B;をクリックし、 **[!UICONTROL 保存]**.

   >[!NOTE]
   >
   >ローカルユーザーをディレクトリグループに追加することはできません。ただし、ディレクトリユーザーをローカルグループに追加することはできます。

   * グループからユーザーを削除するには、そのグループのチェックボックスをオンにして、 **[!UICONTROL 削除]**&#x200B;をクリックし、 **[!UICONTROL 保存]**.


1. ユーザーの役割を編集するには、 **[!UICONTROL 役割の割り当て]** タブに移動し、次のタスクを実行します。

   * 役割のリストを表示するには、 **[!UICONTROL ロールの検索]**.
   * ロールを追加するには、そのロールのチェックボックスをオンにして、 **[!UICONTROL OK]**&#x200B;をクリックし、 **[!UICONTROL 保存]**.
   * ロールを削除するには、そのロールのチェックボックスをオンにして、 **[!UICONTROL 割り当て解除]**&#x200B;をクリックし、 **[!UICONTROL 保存]**.
...
1. ユーザーのチェックボックスを選択し、 **[!UICONTROL 削除]**&#x200B;をクリックし、 **[!UICONTROL OK]**.
