...
**ユーザー：** ポリシーで保護されたドキュメントと、受け取り、使用する保護されたドキュメントに関する監査イベントを表示できます。

**ポリシーセットコーディネーター：** ポリシーセットのポリシーで保護されたドキュメントの監査イベント（ドキュメントイベントやポリシーイベントなど）を表示できます。

**管理者：** すべてのポリシーで保護されたドキュメントとユーザーに関連する監査イベントを表示できます。 管理者はそれ以外のタイプのイベント（ユーザーイベント、ドキュメントイベント、ポリシーイベント、システムイベント）も追跡できます。
...
**ユーザー：** ポリシーで保護されたドキュメントと、受け取り、使用する保護されたドキュメントに関する監査イベントを表示できます。 次の検索オプションを使用できます。

**自分に関連するイベント：** ユーザーは、作成または受け取った任意のポリシーで保護されたドキュメントのイベントを検索できます。 例えば、他の人が保護しているドキュメントを開いたり、表示したり、印刷したりした場合、そのドキュメントに関するイベントのみが表示されます。

**自分のドキュメントに関連するイベント：** ユーザーは、ポリシーで保護された独自のドキュメントに関連するすべてのイベントを検索できます。 ユーザーは、自分のドキュメントにアクセスしたすべての人によって生成されたイベントを確認できます。

**ポリシーセットコーディネーター：** ポリシーセットのポリシーで保護されたドキュメントの監査イベント（ドキュメントイベントやポリシーイベントなど）を表示できます。 指定できるオプションは次のとおりです。
...
**管理者：** すべてのポリシーで保護されたドキュメントとユーザーに関連する監査イベントを表示できます。 管理者はそれ以外のタイプのイベントも追跡できます。管理者はユーザーのタイプに応じてイベント検索をさらに細分化することもできます。
