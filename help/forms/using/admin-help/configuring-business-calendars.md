...
1. ユーザーに適切な業務カレンダーを割り当てる方法を決定します。ユーザーに業務カレンダーを関連付ける方法は 2 つあります。
   ...
   **グループのメンバーシップ：** ユーザーのグループメンバーシップに基づいて、業務カレンダーをユーザーに割り当てることができます。この場合、グループ内の各ユーザーは同じ業務カレンダーを使用します。
   ...
   **業務カレンダーキー：** User Managementで指定された設定である業務カレンダーキーに基づいて、業務カレンダーをユーザーに割り当てることができます。その後、業務カレンダーキーを forms ワークフローの業務カレンダーにマップします。
...
1. [] オプション「営業時間を使用」を選択して、稼働日の開始時間と終了時間を指定します。
...
1. 左側にあるカレンダーで、祝日など、その他の非稼働日をダブルクリックします。過去の日付は選択できません。選択した非稼働日が右側のリストに表示され、1 行に日付が 2 回示されます。左側の日付を選択し、非稼働日の名前または説明を入力します。
   ...
   リストから非稼働日を削除するには、その日の横にある![bus_cal_trash](assets/bus_cal_trash.png)をクリックします。
