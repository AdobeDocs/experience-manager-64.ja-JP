...
* User Management では、拡張文字によって 2 つのドメイン名を区別することはできません。For example, if you create a domain named *abcde* and a domain named *âbcdè *, they are considered the same.
