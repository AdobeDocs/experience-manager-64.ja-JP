...
* タスクを開かずに、TODO リストから
   ...
   注意：このオプションは、プロセスの設計時に、Workbenchの`Assign Task`手順で`isMustOpenToComplete`フィールドが選択されていない場合に使用できます。
...
1. 次のいずれかの手順を実行します。
   ...
   * フォームにボタンがなく、AEM Formsのワークスペースの「完了」ボタンを使用できる場合は、「**完了**」をクリックします。
...
>[!NOTE]
>
>適切な電子メールテンプレートを使用するようにWorkspaceを設定するには、『[AEM FormsJEE管理者ガイド](https://help.adobe.com/en_US/AEMForms/6.1/AdminHelp/)』を参照してください。
