...
![アダプティブフォーム](assets/layouts.png)**図のルートパネルのパネルレイアウトのリスト:** *アダプティブフォームのパネルレイアウトのリスト*
...
**図：** *複数手順フォームのウィザードレイアウトでのステップ完了式*
...
**図：** *フォームのヘッダー部分にパネルタイトルを表示するモバイルレイアウト*
...
**図：** *フォームのヘッダー部分にパネルタイトルを表示しないモバイルレイアウト*
