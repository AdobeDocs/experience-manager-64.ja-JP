...
この節では、Correspondence Management のテキストエディタで使用できる様々なキーボードとアクセシビリティのショートカットを示します。 次の作業を行う際に、これらのショートカットを使用できます。
