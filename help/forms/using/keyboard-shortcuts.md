...
|---|---|---|
| 選択したアダプティブフォームコンポーネントのプロパティブラウザを開く | Alt + Enter | Alt + Return |
...
* [テキスト](document-fragments.md)アセットの作成または編集
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td><p>Shift + 左矢印キー</p> </td> 
   <td>Shift + 左矢印キー</td> 
  </tr>
  <tr>
   <td><p>右方向に 1 文字ずつテキストを選択する</p> </td> 
   <td><p>Shift + 右矢印キー</p> </td> 
   <td>Shift + 右矢印キー</td> 
  </tr>
  <tr>
