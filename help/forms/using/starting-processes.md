...
1. フォームと共に表示される指示に従ってフォームに入力します。必要に応じて、「**最大化**」をクリックしてフォームの表示領域を拡大します。
...
1. 「**OK**」をクリックします。ファイルがフォームに添付されます。添付ファイルの横にある「**削除**」ボタン![ごみ箱の画像](assets/icondelete.png)」をクリックして、ファイルを削除できます。
