...
[フォームデータモデル](create-form-data-model-tutorial.md)の作成の節で説明したように、**FDM_Create_First_IC**&#x200B;をフォームデータモデルとして使用し、このチュートリアルでドキュメントフラグメントを作成します。
...
1. 次の情報を指定します。
   ...
   1. **「**&#x200B;タイトル&#x200B;**」フィールドに、名前としてcustomer_details_first_ic**&#x200B;と入力します。 「**名前**」フィールドにタイトルが自動入力されます。
   1. 「**データモデル**」セクションから、「**フォームデータモデル**」を選択します。
   1. **FDM_Create_First_IC** をフォームデータモデルとして選択し、「**選択**」をタップします。
   1. 「**次へ**」をタップします。
...
1. 次の情報を指定します。
   ...
   1. **「**&#x200B;タイトル&#x200B;**」フィールドに、名前としてsummary_charges_first_ic**&#x200B;と入力します。 「名前」フィールドにタイトルが自動入力されます。
   1. 「**データモデル**」セクションから、「**フォームデータモデル**」を選択します。
   1. **FDM_Create_First_IC** をフォームデータモデルとして選択し、「**選択**」をタップします。
   1. 「**次へ**」をタップします。
