...
**desktopviewFigure:** *左側にヘッダーレイアウトを持つテーブルのデスクトップビュー*

![](assets/headersontheleft.png)
**headersonthelfetFigure:** *左側にヘッダーレイアウトを持つテーブルのモバイルビュー*
...
**図：** *モバイルデバイス上で2列しか表示されない、表の折りたたまれた列*

![collapsible_](assets/collapsible_column.png)
**columnFigure:** *モバイルデバイス上で展開された表の列*
