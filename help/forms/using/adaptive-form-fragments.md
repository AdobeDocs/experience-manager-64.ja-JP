...
1. 「**[!UICONTROL アダプティブフォームとインタラクティブ通信Webチャネルの設定]**」を検索してクリックし、編集モードで開きます。
...
「アセットを埋め込む」ボタンをクリックして、アダプティブフォーム内にアダプティブフォームフラグメントを埋め込むことができます。*fragmentName *]**ボタン（追加したフラグメントのパネルツールバー）をクリックします。次に例を示します。**[!UICONTROL 
