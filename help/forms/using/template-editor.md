...
1. テンプレートコンソールで、作成したフォルダー内の「**[!UICONTROL 作成]**」をタップします。
1. 「テンプレートタイプを選択」セクションで、「**[!UICONTROL アダプティブフォームテンプレート]**」を選択し、「**[!UICONTROL 次へ]**」をタップします。
1. 「テンプレート詳細」セクションで、テンプレートのタイトルを指定し、「**[!UICONTROL 作成]**」をタップします。
...
タッチ UI エディターについて詳しくは、[アダプティブフォームのオーサリングの概要](/help/forms/using/introduction-forms-authoring.md)を参照してください。
...
1. テンプレートを選択して、ツールバーで「**[!UICONTROL 有効]**」をタップします。
...
テンプレートを作成して有効にすると、アダプティブフォームの作成時に Forms Manager で使用できるようになります。 テンプレートを使用してアダプティブフォームを作成するには、 [アダプティブフォームの作成](/help/forms/using/creating-adaptive-form.md).
...
1. AEM Formsオーサーインスタンスにログインし、に移動します。 **[!UICONTROL ツール/操作/ Web コンソール]**.
...
1. **[!UICONTROL FormsManager 設定]**&#x200B;を探して開きます。
   ...
   * AEM 6.0 Forms または AEM 6.1 Forms リリースで追加され、現在非推奨になっているアダプティブフォームの初期設定済みテンプレートを表示または非表示にするには、「**AEM 6.0 の AF テンプレートを含める**」オプションをオンまたはオフにします。このオプションがオンの場合、有効にするには **[!UICONTROL 標準搭載の AF および AD テンプレートを含める]** 設定を有効にします。

1. 「**[!UICONTROL 保存]**」をクリックします。標準のテンプレートの表示オプションが変更されます。
