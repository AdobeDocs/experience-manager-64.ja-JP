...
![フォームポータルページ ](assets/forms-portal-page.png)**図の例：** *フォームポータルページのサンプル*
...
![アドバンス検索ダイアログ](assets/search-panel.png)**図：** *アドバンス検索ダイアログ*
...
![アダプティブフォーム](assets/filling_a_form.png)**図の例：** *アダプティブフォームのサンプル*
...
![ドラフト&amp;送信コンポーネント](assets/draft-submission.png)**図：** *ドラフトと送信コンポーネント*
