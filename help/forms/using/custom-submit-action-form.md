...
>[!NOTE]
>
>リダイレクト URL は、ありがとうございますページ設定を使って作成者が指定します[OOTB送信アクションは](/help/forms/using/configuring-submit-actions.md) 、リダイレクトURLを使用して、転送パスが参照するリソースからブラウザーをリダイレクトします。
>
