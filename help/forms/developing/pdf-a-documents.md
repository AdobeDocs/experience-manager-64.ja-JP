...
## プログラムによるPDF/Aの準拠の判断{#programmatically-determining-pdf-a-compliancy}
...
[WebサービスAPIを使用したPDF/Aの準拠の判断](pdf-a-documents.md#determine-pdf-a-compliancy-using-the-web-service-api)
