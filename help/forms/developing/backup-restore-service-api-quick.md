...
description: Java APIクイックスタートを使用してバックアップモードを開始および終了するには、バックアップと復元サービスAPIを使用します。
seo-description: Java APIクイックスタートを使用してバックアップモードを開始および終了するには、バックアップと復元サービスAPIを使用します。
