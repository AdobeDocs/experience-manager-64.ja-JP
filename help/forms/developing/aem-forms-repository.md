...
description: AEM Forms API と Web Service API を使用して、フォルダーの作成、書き込み、リスト作成、リソースの読み取り、更新、およびリソースの検索をおこなうための Java リポジトリを管理します。 さらに、リソースの関係の作成方法や、リソースのロックと削除の方法についても説明します。
