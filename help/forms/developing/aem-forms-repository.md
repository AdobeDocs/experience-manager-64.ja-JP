...
description: Java APIとWebサービスAPIを使用して、AEM Formsリポジトリを管理し、フォルダーの作成、書き込み、リスト、読み取り、リソースの更新、およびリソースの検索をおこないます。 さらに、リソースの関係の作成、リソースのロックと削除の方法についても説明します。
