---
title: AEM 6.4 リリースノート
seo-title: AEM 6.4 リリースノート
description: AEMリリースノートでは、新機能、サポートされているプラットフォーム、非推奨機能および削除された機能、既知の問題など、AEMの最新リリースに関する重要な情報について説明します。
seo-description: AEMリリースノートでは、新機能、サポートされているプラットフォーム、非推奨機能および削除された機能、既知の問題など、AEMの最新リリースに関する重要な情報について説明します。
...
AEMリリースノートでは、新機能、サポートされているプラットフォーム、非推奨機能および削除された機能、既知の問題など、AEMの最新リリースに関する重要な情報について説明します。
...
| ユーザーガイド | 説明 |
|--- |---|
| [Assets ユーザーガイド](/help/assets/home.md) | デジタルアセットの作成、管理、配信および最適化を行います。 |
...
詳しくは、https://www.adobe.com/legal/terms/enterprise-licensing.htmlを参照してくだ [さい。](https://www.adobe.com/legal/terms/enterprise-licensing.html)
