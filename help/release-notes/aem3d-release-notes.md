...
「AEM 3DとAutodesk Maya [の統合](/help/assets/integrate-maya-with-3d.md) 」および「AEM 3DとAutodesk 3ds Maxの [統合」も参照してください](/help/assets/integrating-aem-3d-with-autodesk-3ds-max.md)。
...
| MA、MB | ネイティブな Autodesk Maya | Windows のみ | Autodesk Mayaは、作成者ノードでこれらのファイルフォーマットを有効にする必要があります。 See [Integrating AEM 3D with Autodesk Maya](/help/assets/integrate-maya-with-3d.md). |
| JT | Siemens PLM オープン CAD | Windows のみ | Autodesk Mayaは、作成者ノードでこれらのファイルフォーマットを有効にする必要があります。 See [Integrating AEM 3D with Autodesk Maya](/help/assets/integrate-maya-with-3d.md). |
| * | Autodesk Maya でサポートされているその他の 3D 入力形式を有効にすることができます。See [Enabling Additional Formats Supported by Maya](/help/assets/integrate-maya-with-3d.md#enabling-additional-formats-supported-by-maya). | Windows のみ | Autodesk Mayaは、作成者ノードでこれらのファイルフォーマットを有効にする必要があります。 See [Integrating AEM 3D with Autodesk Maya](/help/assets/integrate-maya-with-3d.md). |
| MAX | ネイティブAutodesk 3ds Max | Windows のみ | このファイル形式を有効にするには、Autodesk 3ds Maxが作成者ノードで必要です。 「AEM 3DとAutodesk 3ds Max [との統合](/help/assets/integrating-aem-3d-with-autodesk-3ds-max.md)」を参照してください。 |
