...
1. 見出しコンポーネントを選択すると、ツールバーが他のコンポーネントと同様に表示されます。 「**[!UICONTROL 編集]**」を選択します。
...
1. Web.Retailジャーナルアプリケーションを公開サーバーで読み込むか、ページエディターの **[!UICONTROL ページ表示]****(Page Information** )メニューから「公開済み」オプションを使用します。
...
1. まだ読み込まれていない場合は、Web.Retailジャーナルアプリケーションを公開サーバーに読み込むか、ページエディターの **[!UICONTROL ページ表示]****(Page Information** )メニューから「公開済み」オプションを使用します。
