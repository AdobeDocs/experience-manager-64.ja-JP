...
* [AEMバージョン6.4（サービスパック2以降）](/help/release-notes/sp-release-notes.md)
* [GitHubで入手可能なサンプルWe.Retailジャーナルアプリをインストールします。](https://github.com/Adobe-Marketing-Cloud/aem-sample-we-retail-journal)

>[!CAUTION]
>
>このドキュメントは、 [We.Retailジャーナルアプリをデモ目的でのみ使用します](https://github.com/Adobe-Marketing-Cloud/aem-sample-we-retail-journal) 。 どのプロジェクト作業にも使用しないでください。
>
...
1. We.Retailジャーナルアプリケーションを公開サーバーで読み込むか、ページエディターの **[!UICONTROL Page Information]** (ページ情報 **)メニューから「公開済み」オプション** 表示を使用して読み込みます。
...
1. まだ読み込まれていない場合は、We.Retailジャーナルアプリケーションを公開サーバーで読み込むか、ページエディターの **[!UICONTROL Page Information]** (ページ情報 **)メニューから「公開済み」オプション** 表示を使用して読み込みます。
