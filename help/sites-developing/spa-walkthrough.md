...
1. We.Retail Journalアプリケーションを公開サーバーで読み込むか、ページエディターの **[!UICONTROL Page Information]** (ページ情報 **** )メニューから「公開済みとして表示」オプションを使用します。
...
1. まだ読み込まれていない場合は、We.Retail Journalアプリケーションを公開サーバーに読み込むか、ページエディターの **[!UICONTROL Page Information]** (ページ情報 **** )メニューから「発行済みとして表示」オプションを使用します。
