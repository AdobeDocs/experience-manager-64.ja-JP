...
>
>現在では、HTL が AEM の推奨スクリプティング言語とされています。方法を比較するには、[HTL](https://helpx.adobe.com/jp/experience-manager/htl/user-guide.html)と[AEMコンポーネントの開発](/help/sites-developing/developing-components.md)を参照してください。
