...
* [Java API のベストプラクティス](https://docs.adobe.com/content/help/en/experience-manager-learn/foundation/development/understand-java-api-best-practices.html)
...
[AEM Communities](/help/communities/overview.md) オンプレミスのコミュニティの作成と管理が簡単になります。

Communities のベストプラクティスは、こちらで説明しています。

|  |  |  |
|---|---|---|
| ユーザー生成コンテンツ (UGC) の操作に関するベストプラクティス | [コーディングのガイドライン](/help/communities/code-guide.md) | 柔軟でポータブルな、 [ソーシャルコンポーネントフレームワーク](/help/communities/scf.md) (SCF)。 |
...
>[!NOTE]
>
>次のマルチパートチュートリアルは、新しいAEMプロジェクトを設定する際のベストプラクティスとして役立つ場合があります。コアコンポーネント、編集可能テンプレート、クライアントライブラリおよびコンポーネント開発の詳細を説明します。\
