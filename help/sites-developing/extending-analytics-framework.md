...
description: Adobe Analyticsフレームワークのカスタマイズ
...
Adobe Analytics内には、フレームワーク**上で設定可能な定義済みの変数が多数あります。 **デフォルトでは、**charset**、**cookieLifetime**、**currencyCode**&#x200B;および&#x200B;**trackInlineStats**&#x200B;変数が&#x200B;**一般的な解析設定**&#x200B;リストーに含まれます。
