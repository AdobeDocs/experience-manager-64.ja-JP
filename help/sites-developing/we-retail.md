...
| [HTML テンプレート言語](https://helpx.adobe.com/experience-manager/htl/user-guide.html) | すべてのコンポーネントが HTL に基づいています。 |  |
...
| [コアコンポーネント](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) | すべてのコンポーネントが新しいコアコンポーネントに基づいており、使いやすく、設定変更も手早くおこなえます。 | [試してみる](/help/sites-developing/we-retail-core-components.md) |
...
|---|---|---|
| グローバル化されたサイト構造 | 国別のサイトにライブコピーされた言語マスター | 使用不可 |
| コンテンツフラグメント | 使用可 | 使用不可 |
| エクスペリエンスフラグメント | 使用可 | 使用不可 |
| レスポンシブレイアウト | すべてのページ | Geometrixxメディアのみ |
| 編集可能テンプレート | すべてのページ | 使用不可 |
...
| 列コントロール | レイアウトコンテナに置き換えられました | 使用可 |
| Forms | 使用不可 | 使用可 |
...
* [GitHubでaem-sample-we-retailプロジェクトを開く](https://github.com/Adobe-Marketing-Cloud/aem-sample-we-retail)
