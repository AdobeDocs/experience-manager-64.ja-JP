...
BundleContext を使用して、MBean を OSGi サービスとして登録します。Include the JMX-related information in the Dictionary object that you use as an argument of the `BundleContext.registerService` method.
...
>[!NOTE]
>
>簡単にするために、この例のコードは、ログ記録やスローされた例外に対する反応を実行しません。
