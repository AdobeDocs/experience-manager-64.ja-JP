...
クエリの記述は、単に述語（[`Predicate`](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/Predicate.html)）のセットです。例としては、XPathの関数に対応するフルテキスト述語が `jcr:contains()` あります。
...
1. XPathクエリをXPathとして「Explainクエリ」に貼り付けて、クエリ計画を完了
