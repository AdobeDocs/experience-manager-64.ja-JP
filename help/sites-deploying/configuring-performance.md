...
* 編集を行う時間枠（通常は1日の勤務期間、海外での運用の場合はさらに長くなります）。
...
>[!TIP]
>
>セキュリティで保護されたコンテンツのキャッシュについては、『ディスパッチャー』ガイドの「セキュリティで保護されたコンテンツのキャッシュ[」を参照してください。](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/permissions-cache.html)
