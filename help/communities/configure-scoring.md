...
1. **[!UICONTROL Adobe Experience ManagerWebコンソールログのサポート]**&#x200B;にアクセスします。

   * http://localhost:4502/system/console/slinglog

1. **[!UICONTROL 追加新しいロガー]**&#x200B;を選択

   1. **[!UICONTROL ログレベル]**&#x200B;に`DEBUG`を選択
   1. **[!UICONTROL ログファイル]**&#x200B;の名前を入力します（例：）

      * logs/scoring-debug.log
   1. 2つの&#x200B;**[!UICONTROL ロガー]** （クラス）エントリを入力します（`+`アイコンを使用）
...
Adobeリポジトリから開発者が入手できる、インストール済みの[リリース](deploy-communities.md#LatestReleases)の最新のJavadoc。 [Communities 用 Maven の使用：Javadoc](maven.md#javadocs) を参照してください。
...
1. 一意のIDを持つAEMサイト（ウィザードを使用して作成されたコミュニティサイト）:
   ...
   * [はじめにチュートリアル](getting-started.md)で作成した入門チュートリアル（ソーシャル）サイトの使用
   * フォーラムページのノードを見つけます
...
* [コミュニティサイトまたはグループテンプレートに含めるリーダーボード](functions.md#leaderboard-function) 機能。
