...
* [バージョン4.10](https://archive.apache.org/dist/lucene/solr/4.10.4/) または [バージョン5](https://archive.apache.org/dist/lucene/solr/5.5.3/)
...
* AEM-SOLR-MLS zipアーカイブをSolrをホストするサーバにダウンロードする
* アーカイブの解凍
