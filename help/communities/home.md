---
title: AEM 6.4 Communities ユーザーガイド
seo-title: AEM 6.4 Communities ユーザーガイド
description: このガイドでは、フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能など、すべてのAEM Communitiesタスクについて説明します。
seo-description: フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能など、すべてのAEM Communitiesタスクについて説明します。
...
# AEM 6.4 Communities ユーザーガイド

このガイドでは、フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能など、すべてのAEM Communitiesタスクについて説明します。
