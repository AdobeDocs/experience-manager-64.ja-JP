---
title: AEM 6.4 Communitiesユーザーガイド
seo-title: AEM 6.4 Communitiesユーザーガイド
description: このガイドでは、フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能などのオンラインエクスペリエンスの作成など、AEM Communitiesのすべてのタスクについて説明します。
seo-description: フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能などのオンラインエクスペリエンスの作成など、AEM Communitiesのすべてのタスクについて説明します。
...
# AEM 6.4 Communitiesユーザーガイド

このガイドでは、フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能などのオンラインエクスペリエンスの作成など、AEM Communitiesのすべてのタスクについて説明します。
