...
description: このガイドでは、フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能などのオンラインエクスペリエンスの作成など、すべてのAEM Communitiesタスクについて説明します。
...
このガイドでは、フォーラム、ユーザーグループ、学習リソース、その他のソーシャル機能などのオンラインエクスペリエンスの作成など、すべてのAEM Communitiesタスクについて説明します。
