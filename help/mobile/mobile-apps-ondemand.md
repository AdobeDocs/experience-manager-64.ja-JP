...
description: このページでは、AEM Mobile On-Demand Services の作成者の役割と責務について説明します。
...
AEMの作成者は、AEM Mobile On Demand Services を使用してアプリを作成する際に、次のタスクを実行します。
...
>[!NOTE]
>
>AEMのテンプレートとコンポーネントの基本について詳しくは、次のリソースを参照してください。
>
