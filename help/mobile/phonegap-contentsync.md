...
>[!NOTE]
>
>コンテンツ同期ハンドラーの開発のガイドラインや、標準のアプリハンドラーの詳細については、「[コンテンツ同期ハンドラーの開発](/help/mobile/contentsync-app-handlers.md)」を参照してください。
