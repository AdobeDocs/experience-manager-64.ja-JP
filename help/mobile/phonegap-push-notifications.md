...
&lt;jcr:root xmlns:jcr=&quot; https://www.jcp.org/jcr/1.0 [&quot; xmlns:nt=&quot;](https://www.jcp.org/jcr/1.0)https://www.jcp.org/jcr/nt/1.0 [](https://www.jcp.org/jcr/nt/1.0)&quot;\
...
ディープリンクとは プッシュ通知のコンテキストでは、これは、アプリを開くか、アプリ内の指定した場所に（開いている場合に）転送するかを許可する手段です。
