...
* テスト可能 **:**
   ...
   各ガイドラインは、客観的にテストし、アクセシビリティの専門家のグループが、そのガイドラインが満たされたことに一般的に同意できるように書かれています。 アクセシビリティガイドラインの課題の 1 つは、技術的にテスト可能なものもあれば、ガイドラインに正しく準拠しているかどうかの判断が人間に委ねられる場合もあることです。WCAG 2.0 は、WCAG 1.0 の一部のガイドラインおよびチェックポイントに見られていた主観性を減らすことを目的として記述されています。

* **優先度の高いコンテキスト実装**&#x200B;をサポート

   WCAG 1.0と同様、WCAG 2.0のガイドラインは、障害を持つ特定のユーザーグループに対してガイドラインに従わない場合の影響に関して、優先度が与えられています。 これにより、作成者は、特定の状況下で最も重要となるガイドラインを十分な情報から判断することができます。また、*アクセシビリティサポート*&#x200B;の概念が導入されました。そのため、作成者は、アクセシビリティサポートが完全ではない Web テクノロジーを最大限に生かす方法を判断したり、アクセシビリティ機能の恩恵を受けられるように、特定の支援テクノロジーまたはブラウザーを使用するようユーザーに要求したりすることができます。
...
WCAG 2.0は、アクセシブルなデザインのための4つの主要な原則から構成されています。 これらは次のとおりです。
