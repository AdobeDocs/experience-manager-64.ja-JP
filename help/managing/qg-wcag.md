---
title: WCAG 2.0 クイックガイド
seo-title: WCAG 2.0 クイックガイド
description: WCAG 2.0 アクセシビリティのガイドラインの概要を確認します。
seo-description: WCAG 2.0 アクセシビリティのガイドラインの概要を確認します。
...
# WCAG 2.0 クイックガイド{#quick-guide-to-wcag}
...
* **テクノロジーに依存しない：**
   ...
   つまり、HTMLに限らず、様々なWebコンテンツ形式に適用できるガイドラインです。 つまり、WCAG 2.0 では、PDF、Flash、JavaScript、およびその他の最新／将来の Web テクノロジーによって生成または提供されるコンテンツをカバーしています。これは、他の Web コンテンツ形式を犠牲にして HTML に焦点を当てていた WCAG 1.0 の弱みに対処することを目的としています。

* **テスト可能：**

   各ガイドラインは、客観的にテストできるように記述され、アクセシビリティの専門家グループがガイドラインの遵守に同意することを保証します。 アクセシビリティガイドラインの課題の 1 つは、技術的にテスト可能なものもあれば、ガイドラインに正しく準拠しているかどうかの判断が人間に委ねられる場合もあることです。WCAG 2.0 は、WCAG 1.0 の一部のガイドラインおよびチェックポイントに見られていた主観性を減らすことを目的として記述されています。

* **優先度の高いコンテキスト実装**&#x200B;をサポート

   WCAG 1.0と同様に、WCAG 2.0のガイドラインは優先事項に基づいており、障碍のある特定のユーザーグループに対して、ガイドラインに従わない場合の影響に関してです。 これにより、作成者は、特定の状況下で最も重要となるガイドラインを十分な情報から判断することができます。また、*アクセシビリティサポート*&#x200B;の概念が導入されました。そのため、作成者は、アクセシビリティサポートが完全ではない Web テクノロジーを最大限に生かす方法を判断したり、アクセシビリティ機能の恩恵を受けられるように、特定の支援テクノロジーまたはブラウザーを使用するようユーザーに要求したりすることができます。
...
WCAG 2.0は、アクセシブルなデザインの4つの主要な原則で構成されています。 これらは次のとおりです。
