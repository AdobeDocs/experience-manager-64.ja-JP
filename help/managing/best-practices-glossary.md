...
この用語集リストは、[プロジェクトチェックリスト](/help/managing/best-practices-checklist.md)のすべての成果物ドキュメントの詳細を（別途）説明しています。
...
* aem認定リード開発者が少なくとも1人
* aem認定アーキテクトを少なくとも1人
* 少なくとも75%の開発者がAEM認定を受けています。

   これにより、認定された開発者はジュニア開発者を指導し、知識の共有と透明性を確保できます。
