...
この [アプリケーションアーキテクチャ](/help/managing/best-practices.md#development-preparation) では、提案されたアプリケーションの動作を明確に定義する必要があります。
...
>[!NOTE]
>
>例については、 [AEMリリースノート](/help/release-notes/release-notes.md).
