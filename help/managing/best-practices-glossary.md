...
プロジェクトの開始時点で詳細を定義できない場合もありますが、初期定義については、話し合い、合意を得る必要があります。 受け入れテストは、多くの場合、基本的な要件（機能およびパフォーマンス）に基づいておこなわれます。
...
[アドビのセキュリティチェックリスト](/help/sites-administering/security-checklist.md)は、インストール時に AEM のセキュリティが保護されていることを確認するために提供されている公式のチェックリストです。インスタンスの整合性を確保するためにおこなう必要のあるセキュリティ対策や検証手順が含まれています。
...
適切な個人向けの技術トレーニングを提供する例えば、開発者、建築家、エンジニア、ビジネスプラクティショナーなど。
...
* AEM認定を受けた開発者の75%以上
   ...
   これにより、認定された開発者がジュニア開発者を指導し、知識の共有と透明性を確保できます。
...
バックアップと復元の概念では、ソリューションで実装される技術的機能の概要を説明します。会社がバックアップおよび復元ポリシーを実行する場合は必須です。
...
BRDは、ビジネスの解決を検討する際に、次の質問に答える必要があります。「この商売は何をしたいの？」
...
* AEM は、ビジネスニーズに合わせて大幅にカスタマイズできます。アップグレードに影響する可能性のあるカスタマイズはすべて完全に文書化する必要があります。例えば、AEMのユーザーインターフェイス(UI)に対する大きな変更があるとします。
...
プロジェクトスポンサーは、プロジェクトの成功に関連するビジネスの期待事項を収集します。プロジェクトの開始時に期待をすべて満たすことが重要です。これらの期待は、導入全体で行われるすべての決定に影響を与える必要があります。
...
すべての環境に最低限必要なハードウェアが配置されることを確認します。
...
テストコンテンツは、可能な限り実稼動コンテンツに近付ける必要があります。すべてのシナリオをテストできるように、十分な幅を持つ必要があります。
