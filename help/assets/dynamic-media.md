...
>[!NOTE]
>
>ダイナミックメディアの使用とAEMとの統合の違いについて詳しくは、ダイナミックメディアクラシックの統合と [ダイナミックメディア](/help/sites-administering/scene7.md#aem-scene-integration-versus-dynamic-media)の違いを参照してください。
