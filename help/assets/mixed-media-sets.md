...
1. 内 **[!UICONTROL 混在メディアセットエディター]** ページ、内 **[!UICONTROL タイトル]**&#x200B;に、混在メディアセットの名前を入力します。 この名前は、混在メディアセット全般のバナーに表示されます。オプションで、説明を入力します。
...
1. 編集が完了したら、「**[!UICONTROL 保存]**」をタップします。
   ...
   >* 任意の表示モード ( **[!UICONTROL カード]** 表示または **[!UICONTROL 列]** 表示 )、混在メディアセットに移動します。 セットの上にマウスポインターを置き、「**[!UICONTROL 選択]**」（チェックマークアイコン）をタップします。キーボードの **[!UICONTROL Backspace]** キーを押すか、「**[!UICONTROL 詳細]**」（連続する 3 つのドット）をタップしてから「**[!UICONTROL 削除]**」をタップします。
