...
+ Assets の拡張 {#extending}
   ...
   + [AEM Assetsと連携するように ImageMagick をインストールして設定します。](best-practices-for-imagemagick.md)
   + [Assets と Activity Stream の統合](extending-activity-stream.md)
   + [アセットエディターの拡張](asseteditorx.md)
   + [Assets HTTP API](mac-api-assets.md)
   + [Assets プロキシ開発](proxy.md)
+ アセットの管理 {#administer}
   + [Assets でサポートされる形式](assets-formats.md)
   ...
   + [AEM AssetsとAEM MediaLibrary の比較](medialibrary.md)
   ...
   + [コレクション、スニペットおよびスニペットテンプレートのマルチテナント機能](multi-tenancy.md)
   + [透かし](watermarking.md)
...
+ アセットの管理 {#managing}
   + [タッチ操作向け UI を使用したアセットの管理](managing-assets-touch-ui.md)
   ...
   + [AEMでのアセットの並べ替えの強化](enhance-sort.md)
   ...
   + [スマートコンテンツサービストレーニングガイドライン](smart-tags-training-guidelines.md)
