...
>[!NOTE]
>
>ダイ *ナミックメディア —Scene7モード* (AEM 6.4.7.0以降のみ)に適用されます。
...
1. 「Scene7 : アセットを再処理」ワークフローモデルページの右上隅にある「**[!UICONTROL 同期]**」をタップします。When you see **[!UICONTROL Synced]**, the workflow runtime model is successfully synchronized and ready to reprocess asset in a folder.
