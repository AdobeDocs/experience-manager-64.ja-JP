...
# メタデータ、画像、ビデオを処理するプロファイルについて{#profiles-for-processing-metadata-images-and-videos}
...
>[!NOTE]
>
>*Dynamic Media-Scene7モード*&#x200B;に適用されるのは、AEM 6.4.7.0以降のみです。
...
1. **[!UICONTROL Scene7ステップのプロパティ]**&#x200B;へのバッチアップロードダイアログボックスで、次の設定を行います。
