...
実行モードの設定プロパティを定義するには、「 [実行モード](/help/sites-deploying/configure-runmodes.md#defining-configuration-properties-for-a-run-mode) 」を参照してください。
