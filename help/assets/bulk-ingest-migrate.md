...
1. Experience Manager[のAdobeエンタープライズサポートに問い合わせて、機能パック18912のダウンロードを依頼します。 ](https://helpx.adobe.com/jp/contact/enterprise-support.ec.html)サポートに問い合わせる際には、次の情報が必要になる場合があります。
