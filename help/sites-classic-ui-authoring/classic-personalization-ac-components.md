...
* **Adobe Campaign - URL パラメーター**
   ...
   EPK の URL パラメーターを追加します。 例えば、値 **epk** を使用できます。
