---
title: AEM 6.4 Classic UIオーサリングユーザーガイド
seo-title: AEM 6.4 Classic UIオーサリングユーザーガイド
description: 'このガイドでは、従来のユーザーインターフェイスでAEMでのオーサリングの概念について説明します。 '
seo-description: 'クラシックUIでのAEMでのオーサリングの概念について説明します。 '
...
# AEM 6.4 Classic UIオーサリングユーザーガイド

このガイドでは、従来のユーザーインターフェイスでAEMでのオーサリングの概念について説明します。
