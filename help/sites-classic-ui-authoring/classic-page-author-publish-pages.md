...
1. **ツール**&#x200B;コンソールを&#x200B;**ようこそ**&#x200B;ページから選択して開き、**レプリケーション**&#x200B;を重複クリックしてコンソールを開きます(`http://localhost:4502/etc/replication.html`)。
...
1. 実行するアクションを選択します。
   ...
   1. ***が起動するページを確認する場合は、*ドライ作動**&#x200B;を選択します。これはエミュレーションのみで、ページはアクティブ化されません。
