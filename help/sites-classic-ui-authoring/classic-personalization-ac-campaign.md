...
1. AEMで、 **Web サイト** フォルダーを開き、エクスプローラーを参照して電子メールキャンペーンを管理する場所を探します。 次の例では、関係するノードはです。 **Web サイト** > **キャンペーン** > **Geometrixx Outdoors** > **メールキャンペーン**.
...
1. 選択 **新規** > **新しいページ** 新しい e メールコンテンツを作成します。
1. Adobe Campaign 固有の使用可能なテンプレートのいずれかを選択し、ページの一般的なプロパティを入力します。デフォルトでは、次の 3 つのテンプレートが使用可能です。

   * **Adobe Campaign電子メール (AC 6.1)**:コンテンツを事前定義済みのテンプレートに追加してから、配信用にAdobe Campaign 6.1 に送信することができます。
   * **Adobe Campaign E メール (ACS)**:コンテンツを配信用にAdobe Campaign Standardに送信する前に、定義済みのテンプレートに追加できます。

   ![chlimage_1-173](assets/chlimage_1-173.png)

1. クリック **作成** 電子メールまたはニュースレターを作成するには：
...
1. を選択します。 **ページ** サイドキックの「 」タブで、「 」を選択します。 **ページプロパティ。**
1. 内 **クラウドサービス** 」タブで、 **サービスを追加** Adobe Campaignサービスを追加するには、以下をクリックします。 **OK**.

   ![chlimage_1-174](assets/chlimage_1-174.png)

1. 使用しているAdobe Campaignインスタンスに一致する設定をドロップダウンリストから選択し、 **OK**.

   >[!NOTE]
   >
   >クラウドサービスを追加した後、必ず「**OK**」または「**適用**」をタップまたはクリックしてください。そうすると、「**Adobe Campaign**」タブが正しく機能するようになります。

1. (Adobe Campaignから ) デフォルト以外の特定の E メール配信テンプレートを適用する場合 **メール** テンプレート、選択 **ページプロパティ** 再び 内 **Adobe Campaign** 「 」タブで、関連するAdobe Campaignインスタンスで、e メール配信テンプレートの内部名を入力します。

   Adobe Campaign Standard では、このテンプレートは「**AEM コンテンツで配信**」です。Adobe Campaign 6.1 では、このテンプレートは「**AEM コンテンツで E メール配信**」です。

   テンプレートを選択すると、AEMによって **Adobe Campaign** コンポーネント。

### 電子メールコンテンツの編集 {#editing-email-content}

クラシック UI またはタッチ操作向け UI のどちらでも、電子メールコンテンツを編集できます。

1. 「 」を選択して、件名と E メールのテキストバージョンを入力します **ページプロパティ** > **電子メール** ツールボックスから。
...
1. 新しい **ニュースレター** > **テキストおよびパーソナライゼーション (Campaign)** コンポーネント。
1. ダブルクリックしてコンポーネントを開きます。**編集**&#x200B;ウィンドウには、パーソナライゼーション要素を挿入できる機能があります。
   ...
   >
   >詳しくは、 [AEMページとAdobe Campaign E メールのリンク](/help/sites-classic-ui-authoring/classic-personalization-ac-campaign.md#linkinganaempagetoanadobecampaignemail).

   ![chlimage_1-178](assets/chlimage_1-178.png)

1. 選択 **ClientContext** を使用して、ペルソナプロファイルのデータを使用してパーソナライゼーションフィールドをテストします。
...
Adobe Campaignのコンテンツを承認するには、「 **ワークフロー** サイドキックで、を選択します。 **Adobe Campaignの承認** をクリックし、 **ワークフローを開始**. 手順を完了し、コンテンツを承認します。 ワークフローの最後のステップで、「**承認**」の代わりに「**拒否**」を選択して、コンテンツを拒否することもできます。
...
>[!NOTE]
>
>詳しくは、 [AEMとAdobe Campaign StandardおよびAdobe Campaign 6.1 のリンク](/help/sites-authoring/campaign.md#linking-aem-with-adobe-campaign-standard-and-adobe-campaign-classic) under [Adobe Campaign 6.1 とAdobe Campaign Standardの使用](/help/sites-authoring/campaign.md) 詳しくは、標準のオーサリングドキュメントを参照してください。
