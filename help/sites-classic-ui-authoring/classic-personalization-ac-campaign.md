...
1. Adobe Campaign 固有の使用可能なテンプレートのいずれかを選択し、ページの一般的なプロパティを入力します。デフォルトでは、次の 3 つのテンプレートが使用可能です。
   ...
   * **Adobe Campaign電子メール(AC 6.1)**:コンテンツをAdobe Campaign 6.1に送信して配信する前に、事前定義済みのテンプレートに追加できます。
   * **Adobe Campaign電子メール(ACS)**:コンテンツをAdobe Campaign Standardに送信して配信する前に、事前定義済みのテンプレートに追加できます。
