...
以下の手順を実行して、Adobe Analytics統合のリンクトラッキングの動作を調べます。 The procedures show results from [Adobe Experience Cloud Debugger](https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html).
