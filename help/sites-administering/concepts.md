...
AEM は、商品コンテンツを複数言語でサポートします。データを要求すると、統合フレームワークが現在のツリーからその言語を取得します（`/content/geometrixx-outdoors/en_US` の配下のページの場合は `en_US` など）。
...
アカウント情報を管理しやすくするページが提供されています。このページにアクセスするには、geometrixx ページ上部の「**マイアカウント**」をクリックするか、`/content/geometrixx-outdoors/en/user/account.html` に移動します。
