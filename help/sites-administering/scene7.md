...
1. In the sidekick, navigate to the **[!UICONTROL Workflow]** components, and select **[!UICONTROL Dynamic Media Classic]**. ワークフローに **[!UICONTROL Dynamic Media Classic]** をドラッグし、「 **[!UICONTROL 保存]**」をタップします。 ターゲットフォルダー内のAEM Assetsに追加されたアセットは、自動的にDynamic Media Classicにアップロードされます。
...
1. 「 **[!UICONTROL Cloud Services]** 」をタップし、「設定 **[!UICONTROL 」をタップして]** 、「 **[!UICONTROL Dynamic Media Classic]**」を選択します。
