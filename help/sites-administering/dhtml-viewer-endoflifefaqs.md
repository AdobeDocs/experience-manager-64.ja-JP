...
1. 会社が使用しているビューアは、次の表に示す、標準搭載のScene7ビューアに基づく新しいプリセットとして作成され、「ビューアテクノロジ」が「DHTML」に指定されています。

   [https://help.adobe.com/en_US/scene7/using/WS6E593DEA-7D81-4cd6-84B0-85E8BB274176.html#WS1c46793299cf21d77e926d1613177f0a020-8000](https://help.adobe.com/en_US/scene7/using/WS6E593DEA-7D81-4cd6-84B0-85E8BB274176.html#WS1c46793299cf21d77e926d1613177f0a020-8000)

1. 会社で、JSPベースのDHTMLソリューションから作成したカスタムViewerを使用している。
...
1. 会社がJavaScript APIから作成したカスタムViewerを使用している。
...
1. DHTML複数画面フライアウトAPIで作成したカスタムビューアを使用している場合：
...
1. DHTMLデスクトップフライアウトAPIで作成したカスタムビューアを使用している場合：
...
1. 会社がDHTMLビューアパッケージに含まれるデバイス検出ライブラリを使用している。
...
* 標準提供の HTML5 ビューア。これらのビューアは、様々なビューアタイプにまたがって最適化された、基本ズーム、フライアウトズーム、画像セット、スウォッチセット、多次元スピン、混在メディアなどのモバイルインタラクションに対応しています。For full up-to-date examples of these viewers, please refer to: [https://microsite.omniture.com/t2/help/en_US/s7/vlist/vlist.html](https://microsite.omniture.com/t2/help/en_US/s7/vlist/vlist.html)
...
[https://microsite.omniture.com/t2/help/en_US/s7/viewers_ref/index.html#About_HTML5_Viewers](https://microsite.omniture.com/t2/help/en_US/s7/viewers_ref/index.html#About_HTML5_Viewers) （初期設定のViewerの機能とカスタマイズ機能用）

[https://help.adobe.com/en_US/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html](https://help.adobe.com/en_US/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html) （SDK APIドキュメントにアクセスするには）
...
この FAQ で解決しなかった疑問がある場合は、サポート（[s7support@adobe.com](mailto:s7support@adobe.com)）またはアドビのアカウントマネージャーまでお問い合わせください。
