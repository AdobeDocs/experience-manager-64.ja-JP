...
>[!NOTE]
>
>6.4 にアップグレードした後は、/etcからファイルを移動することをお勧めします。詳しくは、「AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules)での[一般的なリポジトリの再構築」を参照してください。
...
エディターで、「**フィルター**」タブの「**I`s Deep`**」をオンまたはオフにできます。
