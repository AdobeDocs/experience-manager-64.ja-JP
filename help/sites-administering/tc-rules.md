...
description: 翻訳が必要なコンテンツを識別する方法を説明します。
...
>[!NOTE]
>
>6.4 にアップグレードした後、/etc からファイルを移動することをお勧めします。 詳しくは、[AEM 6.4 における共通リポジトリの再構築](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules)を参照してください。
...
ここに [コンソール](#translation-rules-ui) 翻訳ルールの設定用に追加された情報です。 UI の定義がファイルに入力されます。
