...
>[!NOTE]
>
>6.4 にアップグレードした後は、/etcからファイルを移動することをお勧めします。詳しくは、 AEM 6.4の](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules)における[一般的なリポジトリ再構築を参照してください。
...
エディターの「**フィルター**」タブで、「**I`s Deep`**」をオンまたはオフにできます。
