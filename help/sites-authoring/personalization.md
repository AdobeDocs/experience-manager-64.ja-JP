...
例えば、We.Retailの商品カタログには、季節商品に注目するためのティーザーが含まれています。 Summer Sports アクティビティは、このティーザーが夏季のターゲットとするマーケティングセグメントを定義します。
...
例えば、We.RetailサンプルWebサイトの女性用ページでは、オファーをティーザー画像として使用し、ページの上部に表示することができます。 30 歳以上の女性向けエクスペリエンスと、30 歳未満の女性向けエクスペリエンスには、それぞれ異なるオファーをティーザーとして使用します。
...
このエンジンは、Adobe Target](/help/sites-administering/opt-in.md)と[が統合されている場合に使用できます。
