...
1. テンプレートを選択します。標準設定では、シンプルなプロジェクト、メディアプロジェクト [翻訳プロジェクト](/help/sites-administering/tc-manage.md)、および [撮影した製品写真製品](/help/sites-authoring/managing-product-information.md) が使用可能になり、「 **次へ**.
