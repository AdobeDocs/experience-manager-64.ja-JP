...
1. プロパティの「スタイル」タブで、スタイルがどのように設定されているかを確認できます。
   ...
   ![プロパティの編集](assets/style-system-properties.png)
...
AEMバージョン6.4.7.0以降、編集ダイアログのオプションの「スタイル」タブが使用できるようになりました。 「デザインダイアログ」タブとは異なり、「編集」ダイアログのタブは、スタイルシステムが機能するのに必須ではありませんが、コンテンツ作成者がスタイルを設定するためのオプションの代替インターフェイスです。
