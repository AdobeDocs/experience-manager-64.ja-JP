...
* **アクティビティタイプ：アクティビティ** タイプ — A/Bテストまたはエクスペリエンスのターゲット設定
* **目的：**（オプション）アクティビティの説明。
...
1. アクティビティを選択し、「**表示のプロパティ**」をクリックまたはタップして、「**レポート**」タブをクリックし、勝者エクスペリエンスのパフォーマンスを表示/コンバージョンするアクティビティを選択します。 パフォーマンスデータが表示されます。
